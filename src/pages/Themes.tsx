...
export default function Themes() {
  ...
  return (
    <div className="min-h-screen bg-offwhite dark:bg-gray-900">
      <header className="border-b border-pump-gray/20 p-4 bg-white dark:bg-gray-800">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-16">
          <div className="w-full md:w-2/3 text-left">
            ...
            <p className="text-lg text-pump-gray dark:text-gray-300 mb-8">
            ...
            <div className="flex gap-4">
              <Button 
                ...
                size="lg"
                className="bg-pump-purple hover:bg-pump-purple/90 dark:bg-pump-purple-light dark:hover:bg-pump-purple-light/90 text-white"
              >
        ...
        {isLoading ? (
          <div className="flex justify-center items-center h-40">
            <p className="text-pump-gray dark:text-gray-300">Carregando temas...</p>
          </div>
        ) : themes.length === 0 ? (
          <div className="text-center p-8">
            <p className="text-pump-gray dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {themes.map((theme) => (
              <Card 
                ...
                className="cursor-pointer hover:shadow-md transition-shadow border-pump-gray/20 bg-white dark:bg-gray-800 dark:border-gray-700"
                style={{
                ...
                <div className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {theme.description && (
                        <p className="text-sm text-pump-gray dark:text-gray-300 mt-1">
                          {theme.description}
                        </p>
                      )}
                    </div>
